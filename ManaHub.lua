...
local Window = Fluent:CreateWindow({
    Title = "x2N HUB-V1.2 BETA-Version",
    SubTitle = "https://discord.gg/alchemyhub",
    TabWidth = 160,
...
local Tabs = {
    Main = Window:AddTab({ Title = "(Main fram)", Icon = "home" }),
    ...
    Hop = Window:AddTab({ Title = "(Hop server)", Icon = "book" }),
...
ImageButton.Image = "rbxassetid://16435032782"
...
local listfastattack = {'Normal Attack','Fast Attack','Super Fast Attack'}
    ...
    local DropdownSelectWeapon = Tabs.Main:AddDropdown("DropdownSelectWeapon", {
        Title = "Chọn Vũ Khí Đi",
        Description = "",
        Values = {'Melee','Kiếm','Blox Fruit'},
        Multi = false,
        Default = 1,
    })
...
local Mastery = Tabs.Misc:AddSection("Ban-Ngày")

Tabs.Misc:AddButton({
	Title = "Xóa xương mù (-10% Hiệu Ứng Skill)",
	Description = "",
	Callback = function()
        NoFog()
    end
...
if Third_Sea then
local ToggleFindMoon = Tabs.Hop:AddToggle("ToggleFindMoon", {Title = "Tìm trăng tròn (Full Moon)",Description = "", Default = false })
...
spawn(function()
    while wait() do
        ...
        elseif game:GetService("Lighting").Sky.MoonTextureId=="http://www.roblox.com/asset/?id=16137232629" then
            Hop()
            Fluent:Notify({
                Title = "x2N HUB-V1.2-BETA (join discords:https://discord.gg/alchemyhub)",
...
local SettingFarm = Tabs.Setting:AddSection("Farming")
    ...
    local ToggleBypassTP = Tabs.Setting:AddToggle("ToggleBypassTP", {Title = "Tele Dạng Reset",Description = "", Default = false })
...
ToggleRemoveNotify:OnChanged(function(Value)
    ...
    local ToggleWhite = Tabs.Setting:AddToggle("ToggleWhite", {Title = "GIẢM LAG MÀNG HÌNH TRẮNG",Description = "", Default = false })
